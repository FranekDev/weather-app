import getWeatherIconPath from './getWeatherIconPath';
...
export const getSvgIcon = (path, color = '#837970') => {
...
export const showDayWeather = (container, dateText, temp, condition) => {
